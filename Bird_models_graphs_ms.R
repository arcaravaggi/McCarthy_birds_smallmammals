...
theme_ac1 <- function(base_family = "comic", base_size_a = 18, base_size_t = 18){
...
overview_density_graph <- ggplot(data = graph_data, aes(x= Treatment, y = Estimate, fill = Analysis)) +
  stat_summary(geom = "bar", fun.y = mean, position = "dodge", width = .8, colour = "black") +
  stat_summary(geom = "errorbar", fun.data = mean_se, position = "dodge", width = .8)  +
